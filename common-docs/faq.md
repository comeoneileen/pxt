...
* You can copy code from and paste code into the JavaScript view of the editor. This lets you move code between MakeCode and other applications on your computer or device.
